...
uniform vec3 fogMaxColor = vec3(0.9137, 0.9608, 0.9882);
uniform vec3 fogMinColor = vec3(0.7255, 0.7843, 0.8196);
...
void main(){
    ...
    float noised = fbm(vec3(uv, depth)+ time, 0.75, 5.5, 0.25, 0.75) * 0.75 + 0.25;

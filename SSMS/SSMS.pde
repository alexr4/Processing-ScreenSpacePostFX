...
public void setup() {
  ...
  sse = loadIncludeFragment(this, dataPath+"ssms-1.glsl", true);
...
public void draw() {
  ...
  filter.getGaussianBlurUltraHigh(albedo,25.0);
  for(int i=0; i<15; i++){
    filter.getGaussianBlurUltraHigh(filter.getBuffer(),25.0);
  }
